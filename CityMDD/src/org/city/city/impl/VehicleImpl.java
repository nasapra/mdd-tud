 ...
 * <ul>
 *   <li>{@link org.city.city.impl.VehicleImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.city.city.impl.VehicleImpl#getDriver <em>Driver</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VehicleImpl extends MinimalEObjectImpl.Container implements Vehicle {
	...
	protected EClass eStaticClass() {
		return CityPackage.Literals.VEHICLE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CityPackage.VEHICLE__NAME, oldName, name));
	}
	...
	public void setDriver(String newDriver) {
		...
		driver = newDriver;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CityPackage.VEHICLE__DRIVER, oldDriver, driver));
	}
